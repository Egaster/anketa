...
def html_for_court(answers):
    ...
    if '19' in answers and answers['19'] == 'yes':
        html += """<p>Наличие уважительных причин невозможности выплатить в полном объеме все долги дает Вам право подать заявление в суд о признании Вас банкротом. К уважительным причинам и их подтверждению относятся, например, справки о временной нетрудоспособности, инвалидности, справка о ДТП и так далее.</p>""" 
